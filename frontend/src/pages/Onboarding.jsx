  ...
  return (
    <div className="max-w-2xl mx-auto px-4 py-10">
      ...
      <div className="w-full bg-gray-200 h-1 mb-6">
        <div 
          className="bg-red-500 h-1 transition-all" 
        ...
        <div className="max-w-md mx-auto">
          ...
          <button
            ...
            className={`w-full bg-red-500 text-white py-3 px-6 rounded-lg font-medium ${
              !userData.username.trim() ? 'opacity-50 cursor-not-allowed' : 'hover:bg-red-600'
            }`}
          >
            Continue
          </button>
      ...
      {currentStep === 3 && (
        <div className="max-w-md mx-auto">
          <h1 className="text-3xl font-bold mb-2">Calendar Preference</h1>
          <p className="text-gray-600 mb-6">How do you manage events?</p>

          <div className="space-y-4 mb-8">
            {['Google Calendar', 'Outlook', 'None'].map((option) => (
              <div
                key={option}
                className={`p-4 border rounded-lg cursor-pointer ${
                  userData.preferences.calendar === option 
      ...
      {currentStep === 4 && (
        <div className="max-w-md mx-auto">
          ...
          <p className="text-gray-600 mb-6">How do you like to add tasks?</p>

          <div className="space-y-4 mb-8">
            {['Manual Entry', 'Email', 'Voice'].map((option) => (
              <div
                key={option}
                className={`p-4 border rounded-lg cursor-pointer ${
                  userData.preferences.taskMethod === option 
                    ? 'border-red-500 bg-red-50' 
                    : 'border-gray-200 hover:bg-gray-50'
                }`}
                onClick={() => {
      ...
      {currentStep === 5 && (
        <div className="max-w-md mx-auto">
          <h1 className="text-3xl font-bold mb-2">Usage Type</h1>
          <p className="text-gray-600 mb-6">How will you use Clarity?</p>

          <div className="space-y-4 mb-8">
            {['Personal', 'Team', 'Family'].map((option) => (
              <div
                key={option}
                className={`p-4 border rounded-lg cursor-pointer ${
                  userData.preferences.usage === option 
                    ? 'border-red-500 bg-red-50' 
                    : 'border-gray-200 hover:bg-gray-50'
                }`}
                onClick={() => {
          ...
          <button
            ...
            className="w-full bg-red-500 hover:bg-red-600 text-white py-3 px-6 rounded-lg font-medium"
          >
            Complete Setup
          </button>
        </div>
