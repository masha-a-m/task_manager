  ...
  const Step3 = () => {
    return (
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-20">
        <div 
          className={`border rounded-lg p-6 w-70 text-center sm:mx-auto cursor-pointer transition-all ${selectedUsage === 'myself' ? 'border-red-400 shadow-md' : 'border-gray-200 hover:shadow-md'}`}
          onClick={() => {
