...
//           if (!localStorage.getItem('clarity_onboardingComplete')) {
//             setIsNewUser(true);
//           }
//         } else {
//           navigate('/login');
...
//           task.id === editingTaskId ? taskToAdd : task
//         );
//       } else {
...
//       // Sort by priority
//       updatedTasks = updatedTasks.sort((a, b) => (a.priority || 4) - (b.priority || 4));
...
//     setIsNewUser(false);
//     localStorage.setItem('clarity_onboardingComplete', 'true');
//   };
